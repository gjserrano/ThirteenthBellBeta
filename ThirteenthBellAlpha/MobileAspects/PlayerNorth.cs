...
namespace ThirteenthBellAlpha.MobileAspects
{
    ...
    /// <summary>
    /// A class representing a player on the North side of the screen
    /// </summary>
    public class PlayerNorth
    {
        /// <summary>
        /// The game object
        /// </summary>
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (state != PlayStateNorth.Idle) timer += gameTime.ElapsedGameTime;
        ...
        /// Draw the player
        /// </summary>
        /// <param name="spriteBatch">player with.  This method should 
